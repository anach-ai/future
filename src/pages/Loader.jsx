...
const Loader = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      navigate(`/home?AUTH-TOKEN=${authToken}`, { replace: true })
    }, 2000) // LOADER_DISPLAY_TIME
